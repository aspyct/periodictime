...
const struct element elements[] = {
    ...
    { .name = "Nitrogen", .code = "N", .number = "7", .mass= "14.00674", .natural_state = gas},
    { .name = "Oxygen", .code = "O", .number = "8", .mass= "15.9994", .natural_state = gas},
    { .name = "Fluorine", .code = "F", .number = "9", .mass= "18.998403", .natural_state = gas},
    { .name = "Neon", .code = "Ne", .number = "10", .mass= "20.1797", .natural_state = gas},
    ...
    { .name = "Chlorine", .code = "Cl", .number = "17", .mass= "35.4527", .natural_state = gas},
    ...
    { .name = "Bromine", .code = "Br", .number = "35", .mass= "79.904", .natural_state = liquid},
    { .name = "Krypton", .code = "Kr", .number = "36", .mass= "83.798", .natural_state = gas},
    ...
    { .name = "Technetium", .code = "Tc", .number = "43", .mass= "97.9072", .radioactive = 1},
    ...
    { .name = "Xenon", .code = "Xe", .number = "54", .mass= "131.29", .natural_state = gas},
    ...
    { .name = "Promethium", .code = "Pm", .number = "61", .mass= "144.9127", .radioactive = 1},
    ...
    { .name = "Mercury", .code = "Hg", .number = "80", .mass= "200.59", .natural_state = liquid},
    ...
    { .name = "Polonium", .code = "Po", .number = "84", .mass = "208.9824", .radioactive = 1},
    { .name = "Astatine", .code = "At", .number = "85", .mass = "209.9871", .radioactive = 1},
    { .name = "Radon", .code = "Rn", .number = "86", .mass = "222.0176", .radioactive = 1, .natural_state = gas},
    { .name = "Francium", .code = "Fr", .number = "87", .mass = "223.0197", .radioactive = 1},
    { .name = "Radium", .code = "Ra", .number = "88", .mass = "226.0254", .radioactive = 1},
    { .name = "Actinium", .code = "Ac", .number = "89", .mass = "227.0278", .radioactive = 1},
    { .name = "Thorium", .code = "Th", .number = "90", .mass = "232.0381", .radioactive = 1},
    { .name = "Protactinium", .code = "Pa", .number = "91", .mass = "231.03588", .radioactive = 1},
    { .name = "Uranium", .code = "U", .number = "92", .mass = "238.0289", .radioactive = 1},
    { .name = "Neptunium", .code = "Np", .number = "93", .mass = "237.048", .radioactive = 1},
    { .name = "Plutonium", .code = "Pu", .number = "94", .mass = "244.0642", .radioactive = 1},
    { .name = "Americium", .code = "Am", .number = "95", .mass = "243.0614", .radioactive = 1},
    { .name = "Curium", .code = "Cm", .number = "96", .mass = "247.0703", .radioactive = 1},
    { .name = "Berkelium", .code = "Bk", .number = "97", .mass = "247.0703", .radioactive = 1, .natural_state = unknown},
    { .name = "Californium", .code = "Cf", .number = "98", .mass = "251.0796", .radioactive = 1, .natural_state = unknown},
    { .name = "Einsteinium", .code = "Es", .number = "99", .mass = "252.083", .radioactive = 1, .natural_state = unknown},
    { .name = "Fermium", .code = "Fm", .number = "100", .mass = "257.0951", .radioactive = 1, .natural_state = unknown},
    { .name = "Mendelevium", .code = "Md", .number = "101", .mass = "258.1", .radioactive = 1, .natural_state = unknown},
    { .name = "Nobelium", .code = "No", .number = "102", .mass = "259.1009", .radioactive = 1, .natural_state = unknown},
    { .name = "Lawrencium", .code = "Lr", .number = "103", .mass = "262.11", .radioactive = 1, .natural_state = unknown},
    { .name = "Rutherfordium", .code = "Rf", .number = "104",  .mass = "261.109", .radioactive = 1, .natural_state = unknown},
    { .name = "Dubnium", .code = "Db", .number = "105",  .mass = "262.114", .radioactive = 1, .natural_state = unknown},
    { .name = "Seaborgium", .code = "Sg", .number = "106",  .mass = "266.122", .radioactive = 1, .natural_state = unknown},
    { .name = "Bohrium", .code = "Bh", .number = "107",  .mass = "264.125", .radioactive = 1, .natural_state = unknown},
    { .name = "Hassium", .code = "Hs", .number = "108",  .mass = "277", .radioactive = 1, .natural_state = unknown},
    { .name = "Meitnerium", .code = "Mt", .number = "109",  .mass = "268.139", .radioactive = 1, .natural_state = unknown},
    { .name = "Darmstadium", .code = "Ds", .number = "110", .mass = "281", .radioactive = 1, .natural_state = unknown},
    { .name = "Roentgenium", .code = "Rg", .number = "111", .mass = "280", .radioactive = 1, .natural_state = unknown},
    { .name = "Copernicium", .code = "Cn", .number = "112", .mass = "285", .radioactive = 1, .natural_state = unknown}
};
